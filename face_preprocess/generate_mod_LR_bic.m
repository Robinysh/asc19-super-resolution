function generate_mod_LR_bic(input_folder, save_LR_folder)
...
if nargin==0
    input_folder = '/data/data/superresolution/DIV2K_train_HR_sub';
    % save_mod_folder = '';
    save_LR_folder = '/data/data/superresolution/DIV2K_train_HR_sub_bicLRx4';
    %save_LR_folder = '/mnt/SSD/xtwang/BasicSR_datasets/DIV2K800/DIV2K800_sub_bicLRx4';
    %save_bic_folder = '/data/data/superresolution/DIV2K_train_HR_sub_bicLRx4';
    % save_bic_folder = '';
end
