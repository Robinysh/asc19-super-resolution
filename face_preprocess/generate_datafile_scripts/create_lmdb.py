...
def main(img_folder=None, lmdb_save_path=None):
    ...
    if  img_folder is None:
        img_folder = '/lustre/users/s1155079039/sr/asc19-super-resolution/face_preprocess/output_images_train/*'  # glob matching pattern
    if  lmdb_save_path is None:
        lmdb_save_path = '/lustre/users/s1155079039/sr/asc19-super-resolution/face_preprocess/output_images_train.lmdb'  # glob matching pattern
